...
<body>
  ...
  <button type="button" class="btn btn-outline-dark btn-rounded waves-effect food common_selector" value="kitten food">Kitten food</button>
  <button type="button" class="btn btn-outline-dark btn-rounded waves-effect food common_selector" value="canned food">Canned food</button>
  <button type="button" class="btn btn-outline-dark btn-rounded waves-effect food common_selector" value="prescription food">Prescription food</button>
      ...
      <div class="col-md-2">
        ...
        <div id="pet" class="collapse">
          <div class="radio border-secondary">
            <label><input type="checkbox" class="common_selector petselect " id="cat" name="optradio" value="cat" checked="checked" disabled>Cat</button></label>
          </div>
        </div>
        ...
        <div id="age" class="collapse">
          <div class="radio">
            ...
            <label><input type="radio" class="common_selector ageselect " name="optradio" value="kitten">Kitten</label>
          </div>
          <div class="radio">
            <label><input type="radio" class="common_selector ageselect " name="optradio" value="adult">Adult</label>
         </div>
       </div>
       <?php 
